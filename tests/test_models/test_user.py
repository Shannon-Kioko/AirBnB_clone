...
class TestUser_instantiation(unittest.TestCase):
    ...
    def test_no_args_instantiates(self):
        """Test if User instance is created with no arguments."""
    ...
    def test_id_is_public_str(self):
        """Test if the id attribute is a public string in User instances."""
    ...
    def test_email_is_public_str(self):
        """Test if the email attribute is a public string in User instances."""
    ...
    def test_args_unused(self):
        """
        Test if User instantiation ignores unused arguments.
        """
        us = User(None)
    ...
    def test_instantiation_with_kwargs(self):
        """
        Test if User instances can be created with keyword arguments.
        """
        dt = datetime.today()
        dt_iso = dt.isoformat()
