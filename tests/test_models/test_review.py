...
class TestReview_instantiation(unittest.TestCase):
    ...
    def test_id_is_public_str(self):
        """Test if the id attribute is a public string in Review instances."""
    ...
    def test_place_id_is_public_class_attribute(self):
        """Test if place_id is a public class attribute in Review instances."""
        rv = Review()
    ...
    def test_user_id_is_public_class_attribute(self):
        """Test if user_id is a public class attribute in Review instances."""
        rv = Review()
    ...
    def test_text_is_public_class_attribute(self):
        """ Test if text is a public class attribute in Review instances."""
        rv = Review()
    ...
    def test_args_unused(self):
        """Test if Review instantiation ignores unused arguments."""
        rv = Review(None)
        self.assertNotIn(None, rv.__dict__.values())

    def test_instantiation_with_kwargs(self):
        """ Test if Review instances can be created with keyword arguments."""
        dt = datetime.today()
        dt_iso = dt.isoformat()
